...
muduo/net/http/CMakeFiles/httprequest_unittest.dir/tests/HttpRequest_unittest.cc.o: ../muduo/net/http/tests/HttpRequest_unittest.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.wP7cYFAtQi/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object muduo/net/http/CMakeFiles/httprequest_unittest.dir/tests/HttpRequest_unittest.cc.o"
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/muduo/net/http && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/httprequest_unittest.dir/tests/HttpRequest_unittest.cc.o -c /tmp/tmp.wP7cYFAtQi/muduo/net/http/tests/HttpRequest_unittest.cc
...
muduo/net/http/CMakeFiles/httprequest_unittest.dir/tests/HttpRequest_unittest.cc.i: cmake_force
	...
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/muduo/net/http && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.wP7cYFAtQi/muduo/net/http/tests/HttpRequest_unittest.cc > CMakeFiles/httprequest_unittest.dir/tests/HttpRequest_unittest.cc.i
...
muduo/net/http/CMakeFiles/httprequest_unittest.dir/tests/HttpRequest_unittest.cc.s: cmake_force
	...
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/muduo/net/http && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.wP7cYFAtQi/muduo/net/http/tests/HttpRequest_unittest.cc -o CMakeFiles/httprequest_unittest.dir/tests/HttpRequest_unittest.cc.s
...
bin/httprequest_unittest: muduo/net/http/CMakeFiles/httprequest_unittest.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.wP7cYFAtQi/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/httprequest_unittest"
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/muduo/net/http && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/httprequest_unittest.dir/link.txt --verbose=$(VERBOSE)
...
muduo/net/http/CMakeFiles/httprequest_unittest.dir/clean:
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/muduo/net/http && $(CMAKE_COMMAND) -P CMakeFiles/httprequest_unittest.dir/cmake_clean.cmake
