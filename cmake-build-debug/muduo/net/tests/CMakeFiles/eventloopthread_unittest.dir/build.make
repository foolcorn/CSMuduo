...
muduo/net/tests/CMakeFiles/eventloopthread_unittest.dir/EventLoopThread_unittest.cc.o: ../muduo/net/tests/EventLoopThread_unittest.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.wP7cYFAtQi/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object muduo/net/tests/CMakeFiles/eventloopthread_unittest.dir/EventLoopThread_unittest.cc.o"
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/muduo/net/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/eventloopthread_unittest.dir/EventLoopThread_unittest.cc.o -c /tmp/tmp.wP7cYFAtQi/muduo/net/tests/EventLoopThread_unittest.cc
...
muduo/net/tests/CMakeFiles/eventloopthread_unittest.dir/EventLoopThread_unittest.cc.i: cmake_force
	...
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/muduo/net/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.wP7cYFAtQi/muduo/net/tests/EventLoopThread_unittest.cc > CMakeFiles/eventloopthread_unittest.dir/EventLoopThread_unittest.cc.i
...
muduo/net/tests/CMakeFiles/eventloopthread_unittest.dir/EventLoopThread_unittest.cc.s: cmake_force
	...
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/muduo/net/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.wP7cYFAtQi/muduo/net/tests/EventLoopThread_unittest.cc -o CMakeFiles/eventloopthread_unittest.dir/EventLoopThread_unittest.cc.s
...
bin/eventloopthread_unittest: muduo/net/tests/CMakeFiles/eventloopthread_unittest.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.wP7cYFAtQi/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/eventloopthread_unittest"
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/muduo/net/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/eventloopthread_unittest.dir/link.txt --verbose=$(VERBOSE)
...
muduo/net/tests/CMakeFiles/eventloopthread_unittest.dir/clean:
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/muduo/net/tests && $(CMAKE_COMMAND) -P CMakeFiles/eventloopthread_unittest.dir/cmake_clean.cmake
