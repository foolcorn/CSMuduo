...
muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.o: ../muduo/base/tests/BoundedBlockingQueue_test.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.BowNfo68sl/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.o"
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.o -c /tmp/tmp.BowNfo68sl/muduo/base/tests/BoundedBlockingQueue_test.cc
...
muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.i: cmake_force
	...
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.BowNfo68sl/muduo/base/tests/BoundedBlockingQueue_test.cc > CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.i
...
muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.s: cmake_force
	...
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.BowNfo68sl/muduo/base/tests/BoundedBlockingQueue_test.cc -o CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.s
...
bin/boundedblockingqueue_test: muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.BowNfo68sl/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/boundedblockingqueue_test"
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/boundedblockingqueue_test.dir/link.txt --verbose=$(VERBOSE)
...
muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/clean:
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests && $(CMAKE_COMMAND) -P CMakeFiles/boundedblockingqueue_test.dir/cmake_clean.cmake
...
muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/depend:
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.BowNfo68sl /tmp/tmp.BowNfo68sl/muduo/base/tests /tmp/tmp.BowNfo68sl/cmake-build-debug /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/DependInfo.cmake --color=$(COLOR)
