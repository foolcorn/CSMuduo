...
muduo/base/tests/CMakeFiles/blockingqueue_bench.dir/BlockingQueue_bench.cc.o: ../muduo/base/tests/BlockingQueue_bench.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.BowNfo68sl/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object muduo/base/tests/CMakeFiles/blockingqueue_bench.dir/BlockingQueue_bench.cc.o"
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/blockingqueue_bench.dir/BlockingQueue_bench.cc.o -c /tmp/tmp.BowNfo68sl/muduo/base/tests/BlockingQueue_bench.cc
...
muduo/base/tests/CMakeFiles/blockingqueue_bench.dir/BlockingQueue_bench.cc.i: cmake_force
	...
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.BowNfo68sl/muduo/base/tests/BlockingQueue_bench.cc > CMakeFiles/blockingqueue_bench.dir/BlockingQueue_bench.cc.i
...
muduo/base/tests/CMakeFiles/blockingqueue_bench.dir/BlockingQueue_bench.cc.s: cmake_force
	...
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.BowNfo68sl/muduo/base/tests/BlockingQueue_bench.cc -o CMakeFiles/blockingqueue_bench.dir/BlockingQueue_bench.cc.s
...
bin/blockingqueue_bench: muduo/base/tests/CMakeFiles/blockingqueue_bench.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.BowNfo68sl/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/blockingqueue_bench"
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/blockingqueue_bench.dir/link.txt --verbose=$(VERBOSE)
...
muduo/base/tests/CMakeFiles/blockingqueue_bench.dir/clean:
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests && $(CMAKE_COMMAND) -P CMakeFiles/blockingqueue_bench.dir/cmake_clean.cmake
...
muduo/base/tests/CMakeFiles/blockingqueue_bench.dir/depend:
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.BowNfo68sl /tmp/tmp.BowNfo68sl/muduo/base/tests /tmp/tmp.BowNfo68sl/cmake-build-debug /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests /tmp/tmp.BowNfo68sl/cmake-build-debug/muduo/base/tests/CMakeFiles/blockingqueue_bench.dir/DependInfo.cmake --color=$(COLOR)
