...
examples/netty/discard/CMakeFiles/netty_discard_server.dir/server.cc.o: ../examples/netty/discard/server.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.wP7cYFAtQi/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/netty/discard/CMakeFiles/netty_discard_server.dir/server.cc.o"
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/netty/discard && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/netty_discard_server.dir/server.cc.o -c /tmp/tmp.wP7cYFAtQi/examples/netty/discard/server.cc
...
examples/netty/discard/CMakeFiles/netty_discard_server.dir/server.cc.i: cmake_force
	...
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/netty/discard && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.wP7cYFAtQi/examples/netty/discard/server.cc > CMakeFiles/netty_discard_server.dir/server.cc.i
...
examples/netty/discard/CMakeFiles/netty_discard_server.dir/server.cc.s: cmake_force
	...
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/netty/discard && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.wP7cYFAtQi/examples/netty/discard/server.cc -o CMakeFiles/netty_discard_server.dir/server.cc.s
...
bin/netty_discard_server: examples/netty/discard/CMakeFiles/netty_discard_server.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.wP7cYFAtQi/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/netty_discard_server"
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/netty/discard && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/netty_discard_server.dir/link.txt --verbose=$(VERBOSE)
...
examples/netty/discard/CMakeFiles/netty_discard_server.dir/clean:
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/netty/discard && $(CMAKE_COMMAND) -P CMakeFiles/netty_discard_server.dir/cmake_clean.cmake
...
examples/netty/discard/CMakeFiles/netty_discard_server.dir/depend:
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.wP7cYFAtQi /tmp/tmp.wP7cYFAtQi/examples/netty/discard /tmp/tmp.wP7cYFAtQi/cmake-build-debug /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/netty/discard /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/netty/discard/CMakeFiles/netty_discard_server.dir/DependInfo.cmake --color=$(COLOR)
