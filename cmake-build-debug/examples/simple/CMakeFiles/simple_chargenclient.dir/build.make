...
examples/simple/CMakeFiles/simple_chargenclient.dir/chargenclient/chargenclient.cc.o: ../examples/simple/chargenclient/chargenclient.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.wP7cYFAtQi/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/simple/CMakeFiles/simple_chargenclient.dir/chargenclient/chargenclient.cc.o"
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/simple && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/simple_chargenclient.dir/chargenclient/chargenclient.cc.o -c /tmp/tmp.wP7cYFAtQi/examples/simple/chargenclient/chargenclient.cc
...
examples/simple/CMakeFiles/simple_chargenclient.dir/chargenclient/chargenclient.cc.i: cmake_force
	...
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/simple && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.wP7cYFAtQi/examples/simple/chargenclient/chargenclient.cc > CMakeFiles/simple_chargenclient.dir/chargenclient/chargenclient.cc.i
...
examples/simple/CMakeFiles/simple_chargenclient.dir/chargenclient/chargenclient.cc.s: cmake_force
	...
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/simple && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.wP7cYFAtQi/examples/simple/chargenclient/chargenclient.cc -o CMakeFiles/simple_chargenclient.dir/chargenclient/chargenclient.cc.s
...
bin/simple_chargenclient: examples/simple/CMakeFiles/simple_chargenclient.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.wP7cYFAtQi/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/simple_chargenclient"
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/simple && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/simple_chargenclient.dir/link.txt --verbose=$(VERBOSE)
...
examples/simple/CMakeFiles/simple_chargenclient.dir/clean:
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/simple && $(CMAKE_COMMAND) -P CMakeFiles/simple_chargenclient.dir/cmake_clean.cmake
...
examples/simple/CMakeFiles/simple_chargenclient.dir/depend:
	cd /tmp/tmp.wP7cYFAtQi/cmake-build-debug && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.wP7cYFAtQi /tmp/tmp.wP7cYFAtQi/examples/simple /tmp/tmp.wP7cYFAtQi/cmake-build-debug /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/simple /tmp/tmp.wP7cYFAtQi/cmake-build-debug/examples/simple/CMakeFiles/simple_chargenclient.dir/DependInfo.cmake --color=$(COLOR)
