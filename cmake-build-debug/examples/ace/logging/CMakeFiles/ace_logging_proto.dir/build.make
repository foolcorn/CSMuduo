...
examples/ace/logging/logrecord.pb.cc: ../examples/ace/logging/logrecord.proto
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/tmp/tmp.BowNfo68sl/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating logrecord.pb.cc, logrecord.pb.h"
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/examples/ace/logging && protoc --cpp_out . /tmp/tmp.BowNfo68sl/examples/ace/logging/logrecord.proto -I/tmp/tmp.BowNfo68sl/examples/ace/logging
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.o: examples/ace/logging/logrecord.pb.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.BowNfo68sl/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.o"
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/examples/ace/logging && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -o CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.o -c /tmp/tmp.BowNfo68sl/cmake-build-debug/examples/ace/logging/logrecord.pb.cc
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.i: cmake_force
	...
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/examples/ace/logging && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -E /tmp/tmp.BowNfo68sl/cmake-build-debug/examples/ace/logging/logrecord.pb.cc > CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.i
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.s: cmake_force
	...
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/examples/ace/logging && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -S /tmp/tmp.BowNfo68sl/cmake-build-debug/examples/ace/logging/logrecord.pb.cc -o CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.s
...
lib/libace_logging_proto.a: examples/ace/logging/CMakeFiles/ace_logging_proto.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.BowNfo68sl/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ../../../lib/libace_logging_proto.a"
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/examples/ace/logging && $(CMAKE_COMMAND) -P CMakeFiles/ace_logging_proto.dir/cmake_clean_target.cmake
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/examples/ace/logging && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/ace_logging_proto.dir/link.txt --verbose=$(VERBOSE)
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/clean:
	cd /tmp/tmp.BowNfo68sl/cmake-build-debug/examples/ace/logging && $(CMAKE_COMMAND) -P CMakeFiles/ace_logging_proto.dir/cmake_clean.cmake
